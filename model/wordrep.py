...
class WordRep(nn.Module):
    def __init__(self, data):
        ...
        if self.use_char:
            ...
            if data.char_feature_extractor == "CNN":
            ...
            elif data.char_feature_extractor == "ATTEN":
                self.char_feature = CharAtten(data.char_alphabet.size(), data.pretrain_char_embedding, self.char_embedding_dim, self.char_hidden_dim, data.HP_dropout, self.gpu)
                ...
                print("Error char feature selection, please check parameter sample_data.char_feature_extractor (CNN/LSTM/GRU/ALL).")
                exit(0)
